...
My dwm config for use with [[https:https://github.com/Zerogaku/Abyss-rice][Abyss-rice]].
Made with [[https:https://github.com/bakkeby/dwm-flexipatch][dwm-flexipatch]].
